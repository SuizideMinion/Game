...
include 'inc/lang/'.getDefaultVariable('sv_server_lang').'_archeology.lang.php';
...
//aktivierungszeit f�r die missioonen in wt
$activate=array (0, 500, 1000, 1500, 2000, 2500, 3000, 3500, 0, 750, 1000);

//ben�tigte arh�ologen f�r die mission
$needarchi=array(
100, //Der g�ldene Kollektor
200, //Die Sondenlager
...
OR $_POST["analyse7"] OR $_POST["analyse8"] OR $_POST["analyse9"] OR $_POST["analyse10"] OR $_POST["analyse11"])
{
  ...
  $tech_ticks=10;
  //schauen ob man genug arch�ologen hat
  $zfp=$needarchi[$aid];
...
*/
    ...
    //////////////////////////////////////////////////////////////////////////
    $aid=0;
    //�berpr�fen, ob die mission schon aktiv 1
    if($tick>=$activate[$aid])
    {
    	//�berpr�fen ob es schon einen datensatz dazu gibt, wenn nicht, einen anlegen
    	...
    	//menge berechnen
    	$energie=floor(getDefaultVariable('sv_kollieertrag')*(100+($ticks/4)));
    ...
    for($aid=3;$aid<11;$aid++)
    {
      ...
      if($tick>=$activate[$aid])
      {
        ...
        case 10: //spielerartefakt
          ...
          //if(getDefaultVariable('sv_server_lang')==1)$atext = $atext.' '.$archeology_lang[paket_10_3];
		  $atext.='<br>Die Mission ist wiederholbar.';
          $lager=$archeology_lang[raumschifflager];
        break;
        case 11: //palenium
			$wiederholbar=true;
          $energie=getDefaultVariable('sv_max_palenium');
          $aname=$archeology_lang[paket_11_1];
          $atext=$archeology_lang[paket_11_2];
          if(getDefaultVariable('sv_server_lang')==1)$atext = $atext.' '.$archeology_lang[paket_11_3];
		  $atext.='<br>Die Mission ist wiederholbar.';
...
/*
  ...
  }//ende seite arch�ologenausbildung
*/
}
echo '</form>';
?>
...
<?php
/*
INSERT INTO `de_tech_data1` VALUES (29, 'Arch�ologiezentrum', 20000, 10000, 50000, 6000, 2, 28, 21400, '4', 'Dieses Geb&auml;ude dient zur Ausbildung von Arch&auml;ologen und zur Analyse der DX61a23-Datenpakete.');
INSERT INTO `de_tech_data2` VALUES (29, 'Arch�ologiehort', 24000, 8000, 54000, 4000, 2, 24, 21400, '4', 'Dieses Geb&auml;ude dient zur Ausbildung von Arch&auml;ologen und zur Analyse der DX61a23-Datenpakete.');
INSERT INTO `de_tech_data3` VALUES (29, 'Arch�ologiebau', 28000, 5000, 42000, 10000, 2, 28, 21400, '4', 'Dieses Geb&auml;ude dient zur Ausbildung von Arch&auml;ologen und zur Analyse der DX61a23-Datenpakete.');
INSERT INTO `de_tech_data4` VALUES (29, 'Arch�ologiestock', 16000, 12000, 46000, 8000, 2, 30, 21400, '4', 'Dieses Geb&auml;ude dient zur Ausbildung von Arch&auml;ologen und zur Analyse der DX61a23-Datenpakete.');
INSERT INTO `de_tech_data5` VALUES (29, 'Arch�ologie-KT-TCK', 22000, 9000, 52000, 5000, 2, 10, 21400, '4', 'Dieses Geb&auml;ude dient zur Ausbildung von Arch&auml;ologen und zur Analyse der DX61a23-Datenpakete.');
*/
?>
