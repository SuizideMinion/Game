...
include 'inc/lang/' . getDefaultVariable('sv_server_lang') . '_menu.lang.php';
include 'inc/' . getDefaultVariable('sv_server_lang') . '_links.inc.php';
include 'inc/lang/' . getDefaultVariable('sv_server_lang') . '_resline.lang.php';
//<meta charset="utf-8">
...
<head>
    ...
    <title><?php echo getDefaultVariable('sv_server_tag'); ?> Die Ewigen - Desktopversion</title>
    <link rel="shortcut icon" href="favicon.ico"/>

    <script type="text/javascript" src="js/jquery.min.js"></script>
    <script type="text/javascript" src="js/jquery-ui.min-1.12.0.js"></script>
    <script type="text/javascript" src="js/ang_fn.js"></script>
    <script type="text/javascript" src="js/de_fn.js"></script>
...
<div style="position: absolute; width: 100%; height: 100%; left: 0px; top:0px;">
    <iframe src="map.php" id="iframe_map" height="100%" width="100%" frameBorder="0"></iframe>
</div>
<?php
...
?>
<div id="iframe_main_container"
     style="position: absolute; width: 620px; height: calc(100% - 64px); left: 0px; top:64px;">
    <iframe src="overview.php" id="iframe_main" name="h" height="100%" width="100%" frameBorder="0"></iframe>
</div>
<div id="iframe_main_container_closer"
     style="position: absolute; left: 620px; top:64px; width: 29px; height: 31px; background-color: rgba(0,0,0, 0.8); border-bottom: 1px solid rgba(22,22,22, 0.8); border-right: 1px solid #222222; cursor: pointer;"
     onclick="closeIframeMain()">
    <img src="g/close_icon.png" style="height: 26px; width: auto; margin-left: 4px; margin-top: 4px;"
         alt="Fenster schlie&szlig;en" title="Fenster schlie&szlig;en" rel="tooltip">
</div>

<div id="iframe_main_container_big"
     style="position: absolute; display: none; width: 100%; height: calc(100% - 64px); left: 0px; top:64px; z-index: 100;"></div>
...
<div id="topbar" style="z-index: 1000;">
    ...
    //VS
    /*
    if(!isset(getDefaultVariable('sv_deactivate_vsystems')) || getDefaultVariable('sv_deactivate_vsystems')!=1){
