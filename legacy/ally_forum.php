...
include('inc/lang/'.getDefaultVariable('sv_server_lang').'_ally_forum.lang.php');
...
<script src="<?php echo getDefaultVariable('sv_server_lang'); ?>_jssammlung.js" type="text/javascript"></script>
