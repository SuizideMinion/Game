...
include('inc/lang/' . getDefaultVariable('sv_server_lang') . '_ally.fleet.lang.php');
...
$full_access = false;
if (has_position("leaderid", $allytag, $ums_user_id,$db) || has_position("coleaderid1", $allytag, $ums_user_id,$db) || has_position("coleaderid2", $allytag, $ums_user_id,$db) || has_position("coleaderid3", $allytag, $ums_user_id,$db) || has_position("fleetcommander1", $allytag, $ums_user_id,$db) || has_position("fleetcommander2", $allytag, $ums_user_id,$db)) {
    $full_access = true;
}
