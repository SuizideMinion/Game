...
include('inc/lang/' . getDefaultVariable('sv_server_lang') . '_ally.allymain.lang.php');
...
*/
function getLink($user, $allyallymain_lang, $db)
{
    $lnk = "";
...
if ($leaderid > -1) {
    $leaderlink = getLink($leaderid, $allyallymain_lang, $db);
}
if ($coleaderid1 > -1) {
    $coleader1link = getLink($coleaderid1, $allyallymain_lang, $db);
}
if ($coleaderid2 > -1) {
    $coleader2link = getLink($coleaderid2, $allyallymain_lang, $db);
}
if ($coleaderid3 > -1) {
    $coleader3link = getLink($coleaderid3, $allyallymain_lang, $db);
}
if ($fcid1 > -1) {
    $fclink1 = getLink($fcid1, $allyallymain_lang, $db);
}
if ($fcid2 > -1) {
    $fclink2 = getLink($fcid2, $allyallymain_lang, $db);
}
if ($toid1 > -1) {
    $tolink1 = getLink($toid1, $allyallymain_lang, $db);
}
if ($toid2 > -1) {
    $tolink2 = getLink($toid2, $allyallymain_lang, $db);
}
if ($moid1 > -1) {
    $molink1 = getLink($moid1, $allyallymain_lang, $db);
}
if ($moid2 > -1) {
    $molink2 = getLink($moid2, $allyallymain_lang, $db);
}
