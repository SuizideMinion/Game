...
include('inc/lang/'.getDefaultVariable('sv_server_lang').'_ally.members.lang.php');
...
if (!has_position("leaderid", $clankuerzel, $ums_user_id, $db)
    && !has_position("coleaderid1", $clankuerzel, $ums_user_id, $db)
    && !has_position("coleaderid2", $clankuerzel, $ums_user_id, $db)
    && !has_position("coleaderid3", $clankuerzel, $ums_user_id, $db)
    && !has_position("memberofficer1", $clankuerzel, $ums_user_id, $db)
    && !has_position("memberofficer2", $clankuerzel, $ums_user_id, $db))
{
	if (!$showactivity)
	{
		$hide_activity = true;
