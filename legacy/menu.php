...
if ($row['logins'] == 1) {
    insert_chat_msg(0, 2, $ums_spielername, ' <font color="#FFFF00">Ich habe mich ' . getDefaultVariable('sv_server_tag') . ' angeschlossen.</font>');
...
<body>';
    ...
    echo '<a href="'. route('building.index') .'"><div class="btn">Technologien new</div></a>';
    ...
    */
    ...
    if (getDefaultVariable('sv_deactivate_sou') == 0) echo '<a href="sou_main.php"><div class="btn">EA</div></a>';
    if (getDefaultVariable('sv_deactivate_sou') == 0) echo '<a href="sou_chat.php"><div class="btn">EA-Chat</div></a>';
        ...
        <script language="javascript">
            ...
            function StartScroll(sDir) {
                if (document.getElementById("menubtns").offsetHeight > document.getElementById("menumain").offsetHeight) {
                    if (aktMinTop == 0) {
                        aktMinTop = document.getElementById('menumain').offsetHeight - document.getElementById('menubtns').offsetHeight
                    }
            ...
            function DoScroll(sDir) {
                ...
                if (sDir == "Up") {
                    var newTop = (aktTop.replace("px", "") * 1) + scrollStep;
                } else {
                    var newTop = (aktTop.replace("px", "") * 1) - scrollStep;
                }
...
if (getDefaultVariable('sv_deactivate_efta') == 0) echo '<div id="gig1" onclick="showefta()" title="' . $menu_lang['eintrag_31'] . '&' . $menu_lang['descefta'] . '"></div>';
if (getDefaultVariable('sv_deactivate_sou') == 0) echo '<div id="gig2" onclick="showsou()" title="' . $menu_lang['eintrag_32'] . '&' . $menu_lang['descsou'] . '"></div>';
