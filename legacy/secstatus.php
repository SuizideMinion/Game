...
include "inc/lang/" . (getDefaultVariable('sv_server_lang') ?? 1) . "_secstatus.lang.php";
...
$filename = basePath("/tickler/runtick.sh");
...
<head>
    ...
    <script type="text/javascript"
            src="js/de_fn.js?<?php echo filemtime($_SERVER['DOCUMENT_ROOT'] . '/js/de_fn.js'); ?>"></script>
    <script>
        <!--
        <?php
        ...
        function deirc(f, se, sy, a1, a2, a3) {
            var lb = "\n";
            var t = "<?php echo $ss_lang['systemstatusvon']?> " + se + ":" + sy + lb;
            var j = 0;
            for (i = 0; i < a1.length / 8; i++) {
                t = t + "ETA: " + a1[j] + " INC: " + a1[j + 1] + " (FP: " + a1[j + 6] + ") DEF: " + a1[j + 4] + " (FP: " + a1[j + 7] + ") " + lb;
                var j = j + 8;
            }
            if (document.getElementsByName("a" + se + "_" + sy)[0].checked == true) {
                t = t + "<?php echo $ss_lang['angreifer']?>: " + a2 + lb;
                i++;
            }
            if (document.getElementsByName("d" + se + "_" + sy)[0].checked == true) {
                t = t + "<?php echo $ss_lang['verteidiger']?>: " + a3 + lb;
                i++;
            }
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr height="37">
        ...
        <td colspan="8" class="ro" align="center">
            <div class="cellu"><b><?php echo $ss_lang['angreifer'] ?> - <?php echo $ss_lang['verteidiger'] ?></b></div>
        </td>
    ...
    <td colspan="8">
        <table border="0" cellpadding="0" cellspacing="1" width="100%">
            ...
            <tr style="text-align: center; line-height: 20px; font-weight: bold;">
                <td>
                    <div class="cell"><?php echo $ss_lang['ziel']; ?></div>
                </td>
                <td>
                    <div class="cell"><?php echo $ss_lang['herkunft']; ?></div>
                </td>
                <td>
                    <div class="cell" title="Rasse">R</div>
                </td>
                <td>
                    <div class="cell"><?php echo $ss_lang['allianz']; ?></div>
                </td>
                <td>
                    <div class="cell"><?php echo $ss_lang['status']; ?></div>
                </td>
                <td>
                    <div class="cell"><?php echo $ss_lang['zeit']; ?></div>
                </td>
                <td>
                    <div class="cell"><?php echo $ss_lang['schiffe']; ?></div>
                </td>
                <td title="Dieser Wert sind die Flottenpunkte. Getarnte Einheiten der Angreifer, wie die Z-Zerst&ouml;rer, werden nicht mit eingerechnet.">
                    <div class="cell">FP <img id="info" style="vertical-align: middle;"
                                              src="<?php echo $ums_gpfad . 'g/' . $ums_rasse; ?>_hilfe.gif"></div>
                </td>
                <td>
                    <div class="cell"><?php echo $ss_lang['aktion']; ?></div>
                </td>
            </tr>
        ...
        if ($ally_id > 0) {
            ...
            if ($show_ally_secstatus > time()) {//wird übermittelt
                ...
                if (isset($_REQUEST['sassys']) && $_REQUEST['sassys'] == $sc[$i][1][0]) {
                    ...
                    $sichtbarkeit = getDefaultVariable('sv_show_ally_secstatus');
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr height="37">
        <td width="13" height="37" class="rol">&nbsp;</td>
        <td colspan="5" class="ro" align="center">
            <div class="cellu"><b><?php echo $ss_lang['sektorflotten'] ?></b></div>
        </td>
        <td width="13" class="ror">&nbsp;</td>
    </tr>
        ...
        <td colspan="5">
            <table border="0" cellpadding="0" cellspacing="1" width="100%">
                ...
                <tr style="text-align: center; line-height: 20px; font-weight: bold;">
                    ...
                    <td title="Dieser Wert sind die Flottenpunkte. Getarnte Einheiten werden mit eingerechnet.">
                        <div class="cell">FP <img id="info" style="vertical-align: middle;"
                                                  src="<?php echo $ums_gpfad . 'g/' . $ums_rasse; ?>_hilfe.gif"></div>
                    </td>
                </tr>
...
if ($ownally != '') {
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr height="37">
            <td width="13" height="37" class="rol">&nbsp;</td>
            <td colspan="8" class="ro" align="center">
                <div class="cellu"><b>Allianzmitglieder</b></div>
            </td>
            <td width="13" class="ror">&nbsp;</td>
        </tr>
