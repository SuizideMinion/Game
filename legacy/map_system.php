...
if(!hasTech($pt,25)){
	...
	<td width="100"><a href="'.$sv_link[0].'?r='.$ums_rasse.'&t=28" ><img src="'.$ums_gpfad.'g/t/'.$ums_rasse.'_25.jpg" border="0"></a></td>
	...
	if($num==1){
		...
		$kosten_zeit=$level*15*60*getDefaultVariable('tech_build_time_faktor')*2;
	}
