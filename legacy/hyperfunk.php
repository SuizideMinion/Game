...
include('inc/lang/' . getDefaultVariable('sv_server_lang') . '_hyperfunk.lang.php');
...
<td width="13" class="rur">&nbsp;</td>
    ...
    if (isset($_POST['antbut'])) {
        $zielsek = $_POST['zielsek'];
        $zielsys = $_POST['zielsys'];
        ...
        } elseif (ctype_digit($zielsek) && ctype_digit($zielsys)) {
...
//                        $sy = (int)$sy;
            ...
            echo insertmessage($hyperfunk_lang['msg_3'], "r", 'fehler');
        }
    }
  ...
  <td width="13" class="rur">&nbsp;</td>
    ...
    if ($action == "arc") {
        ...
        if ($ums_premium == 1)
            $parchiv = getDefaultVariable('sv_hf_archiv_p');
        else
            $parchiv = getDefaultVariable('sv_hf_archiv');
    ...
    if ($action == "eingang" or $action == "" or $action == "ausgang" or $action == "archiv") {
        ...
        while ($row = mysql_fetch_array($db_tfn)) {
            ...
            <table width="566" border="0" cellspacing="1" cellpadding="0">
                <tr>
                    <td width="80" class="cell1" style="text-align: left;">&nbsp;<?php if ($action == "ausgang") {
                    ...
                    <td>
                        <table border="0" width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="cell" style="text-align: left;"><font face="Tahoma" size="2">
                                        <?php
                                        if ($action == "ausgang") {
                                        ...
                                        ?></font></td>
                                <td align="right" class="cell" valign="middle"><?php echo($neuemsg ?? ''); ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td class="cell" style="text-align: left;">&nbsp;<?php echo $hyperfunk_lang['datum'] ?></td>
                    <td class="cell1" style="text-align: left;">&nbsp;<?php echo $time; ?></td>
                </tr>
                <tr>
                    <td class="cell1" style="text-align: left;">&nbsp;<?php echo $hyperfunk_lang['betreff'] ?></td>
                    <td class="cell" style="text-align: left;">
                        &nbsp;<?php echo utf8_encode(umlaut($row['betreff'])); ?></td>
                </tr>
                <tr>
                    <td valign="top" class="cell" style="text-align: left;">
                        &nbsp;<?php echo $hyperfunk_lang['nachricht'] ?></td>
                    <td class="cell1" style="text-align: left;">
                        &nbsp;<?php echo utf8_encode(umlaut($row['text'])); ?></td>
                </tr>
                <tr>
                    <td class="cell1">&nbsp;</td>
                    <td class="cell">&nbsp;
                ...
                <form action="hyperfunk.php" method="post">
                    <table border="0" width="586" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="ro" align="center" colspan="2" nowrap>
                                <div class="cellu"><?php if ($action == "sektor") {
                                    ...
                                    if ($action == "ant") echo $hyperfunk_lang['beantworten'];
                                    if ($action == "weiter") echo $hyperfunk_lang['hfn_nav_4'];
                                    if ($action == "spieler" or $action == "sektor" or $action == "alli") echo $hyperfunk_lang['verfassen']; ?></div>
                            </td>
                        ...
                        <tr class="cellu">
                            ...
                            <td colspan=2 align=center height=50>
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm1.gif" onclick="init('smile1')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm2.gif" onclick="init('smile2')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm3.gif" onclick="init('smile3')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm4.gif" onclick="init('smile4')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm5.gif" onclick="init('smile5')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm6.gif" onclick="init('smile6')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm7.gif" onclick="init('smile7')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm8.gif" onclick="init('smile8')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm9.gif" onclick="init('smile9')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm10.gif" onclick="init('smile10')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm11.gif" onclick="init('smile11')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm12.gif" onclick="init('smile12')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm13.gif" onclick="init('smile13')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm14.gif" onclick="init('smile14')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm15.gif" onclick="init('smile15')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm16.gif" onclick="init('smile16')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm17.gif" onclick="init('smile17')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm18.gif" onclick="init('smile18')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm19.gif" onclick="init('smile19')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <img src="<?php echo $ums_gpfad; ?>g/smilies/sm20.gif" onclick="init('smile20')"
                                     alt="<?php echo $hyperfunk_lang['altsmilie'] ?>">
                                <br>
                                ...
                                <input type="button" value="<?php echo $hyperfunk_lang['gelb'] ?>"
                                       onclick="init('gelb')">
                                <input type="button" value="<?php echo $hyperfunk_lang['gruen'] ?> "
                                       onclick="init('gruen')">
                                <input type="button" value="<?php echo $hyperfunk_lang['weiss'] ?>"
                                       onclick="init('weiss')">
                                <input type="button" value="<?php echo $hyperfunk_lang['Farbe'] ?> "
                                       onclick="init('farbe')">

                                <input type="button" value="<?php echo $hyperfunk_lang['groesse'] ?>"
                                       onclick="init('size')">
                        ...
                        <tr>
                            <td width='13' height='37' class='rl'>&nbsp;</td>
                            <td colspan=2 align="center"><textarea rows="15" cols="64" tabindex="4" name="nachricht"
                                                                   id="nachricht"><?php if ($action == "ant" or $action == "weiter") echo '[i][b]' . $rowtfn['fromnic'] . ' ' . $hyperfunk_lang['schrieb'] . ': [/b]' . umlaut($rowtfn['text']) . '[/i]'; ?></textarea>
                            </td>
                            <td width='13' height='37' class='rr'>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan=2 align=center><input type="button"
                                                              value="<?php echo $hyperfunk_lang['laengepruefen'] ?>"
                                                              onClick="check()"> <input type=submit tabindex="5"
                                                                                        onclick="return zeichenundsmiliecheck()"
                                                                                        name=<?php if ($action == "sektor") {
                                                                                            echo "sekmsg";
                                                                                        } elseif ($action == "alli") {
                                                                                            echo "allimsg";
                                                                                        } elseif ($action == "freunde") {
                                    ...
                                    echo $hyperfunk_lang['hyperfunknachricht'];
                                } ?> <?php print($hyperfunk_lang['msg_31']) ?>" >
                            </td>
                            <td width='13' height='37' class='rr'>&nbsp;</td>
                        </tr>
...
// if($action!="sektor" and $action!="alli" and $action!="freunde" ) echo " onclick=\"return checkobleer()\"";
    ...
    if (isset($friendbtn)) {
        ...
        $sector = (int)($freundsector ?? 0);
        $system = (int)($freundsystem ?? 0);
        ...
        if ($buddy_exist_check >= 1)
            ...
            if ($numcheck == 1) {
                ...
                if ($ums_premium == 1)
                    $pbuddies = getDefaultVariable('sv_hf_buddie_p') ?? '';
                else
                    $pbuddies = getDefaultVariable('sv_hf_buddie') ?? '';
    ...
    if (isset($ignorebtn)) {
        ...
        if ($buddy_exist_check >= 1)
            ...
            if ($numcheck == 1) {
                ...
                if ($ums_premium == 1)
                    $pigno = getDefaultVariable('sv_hf_ignore_p');
                else
                    $pigno = getDefaultVariable('sv_hf_ignore');
    ...
    if (isset($mailhfn)) {
        ...
        $allenachrichten = $hyperfunk_lang['mail_1'] . ' ' . $ums_spielername . '' . $hyperfunk_lang['mail_2'] . ' ' . getDefaultVariable('sv_server_name') . '' . $hyperfunk_lang['mail_3'];
        ...
        @mail_smtp($rowmail['reg_mail'], $hyperfunk_lang['mail_10'] . ' ' . getDefaultVariable('sv_server_name'), nl2br($allenachrichten));
    ...
    if ($action == "optionen") {
        ...
        <form action="hyperfunk.php?action=optionen" method="post">
            <table border="0" cellspacing="0" cellpadding="0" width="300">
                <tr>
                    <td width="13" height="25" class="rol"></td>
                    <td align=center height="35" colspan="2" class="ro">
                        <div class="cellu"><?php echo $hyperfunk_lang['mailservice'] ?></div>
                    </td>
                    <td width="13" height="25" class="ror"></td>
                </tr>
                ...
                <tr>
                    <td width="13" height="25" class="rl">&nbsp;</td>
                    <td align=center height="45" colspan="2" class="cell"><input type="submit" name="mailhfn"
                                                                                 value="<?php echo $hyperfunk_lang['mailservicesend'] ?>"
                            <?php
        ...
        <form action=hyperfunk.php?action=optionen method=post>
            <table border=0 cellspacing=0 cellpadding=0 width=300>
                <tr>
                    <td width='13' height='25' class='rml'></td>
                    <td align=center height='35' colspan=2 class='ro'>
                        <div class="cellu"><?php echo $hyperfunk_lang['meine_freunde'] ?></div>
                    </td>
                    <td width='13' height='25' class='rmr'></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="cell" align="right" width="120" height="30">
                ...
                <tr>
                    ...
                    <td colspan=2 align=center class=cell><input type="submit" name="friendbtn"
                                                                 value="<?php echo $hyperfunk_lang['freund_adden'] ?>">
                    </td>
                    <td width='13' height='25' class='rr'></td>
                </tr>
                <tr>
        ...
        <form action="hyperfunk.php?action=optionen" method="post">
            <table border="0" cellspacing="0" cellpadding="0" width="300">
                <tr>
                    <td width="13" height="25" class="rml"></td>
                    <td align=center class="ro" colspan="2" height="35">
                        <div class="cellu"><?php echo $hyperfunk_lang['ignorelist'] ?></div>
                    </td>
                    <td width="13" height="25" class="rmr"></td>
                </tr>
                ...
                <tr>
                    <td width="13" class="rl" height="25"></td>
                    <td colspan="2" align="center" class="cell"><input type="submit" name="ignorebtn"
                                                                       value="<?php echo $hyperfunk_lang['feind_adden'] ?>">
                    </td>
                    <td width="13" height="25" class="rr"></td>
                </tr>
                <tr>
    ...
    if ( isset($l) ) {
        switch ($l) {
            ...
            default:
                $time = date("YmdHis");
                $para = "Der folgende Spieler $ums_spielername ($asec:$asys)[UserID:$ums_user_id] hat am $time an den Parametern rumgespielt.\n\n\n Der Parameter lautet: \n $l";
                mail_smtp($GLOBALS['env_admin_email'], "Scriptkiddi auf Server getDefaultVariable('sv_server_name') am Werk.", $para);
                break;
        }
    }
    ?>
