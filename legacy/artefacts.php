...
include 'inc/lang/' . getDefaultVariable('sv_server_lang') . '_artefacts.lang.php';
...
if(select==0)
{
$('#msgarea').html('<font color="#FFFFFF">Du hast die M&ouml;glichkeit Artefakte zu benutzen, oder sie zu kombinieren um
    ein neues Artefakt zu erhalten. Klicke dazu das gew&uuml;nschte Artefakt an.<br>Das Geb&auml;ude kannst du mit einem
    Klick auf die Geb&auml;udegrafik ausbauen.</font>');
}
else if(select==1)
{
for(i=0; i<500; i++)
...
if(a[i].useable==1){
$('#msgarea').html('<font color="#00FF00">Dieses Artefakt kann benutzt werden.</font><br><a
    href="artefacts.php?useartefact=1&lid='+a[i].lid+'">Artefakt benutzen</a><br><a
    style="display: inline-block; margin-top: 10px;" href="artefacts.php?destroyartefact=1&lid='+a[i].lid+'"
    onclick="return confirm(\'Artefakt vernichten?\')">Artefakt zerst&ouml;ren und in Palenium umwandeln</a>');
}
else if(a[i].bs==1)
{
$('#msgarea').html('<font color="#00FF00">Dieses Artefakt kann in einem Basisschiff verwendet werden.</font><br><a
    href="artefacts.php?a=1&fid=1&id='+(a[i].id)+'&lvl='+(a[i].level)+'">Heimatflotte</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
    href="artefacts.php?a=1&fid=2&id='+(a[i].id)+'&lvl='+(a[i].level)+'">Flotte I</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
    href="artefacts.php?a=1&fid=3&id='+(a[i].id)+'&lvl='+(a[i].level)+'">Flotte II</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
    href="artefacts.php?a=1&fid=4&id='+(a[i].id)+'&lvl='+(a[i].level)+'">Flotte III</a>
<div style="height: 12px;">&nbsp;</div>
</div><a href="artefacts.php?destroyartefact=1&lid='+a[i].lid+'" onclick="return confirm(\'Artefakt vernichten?\')">Artefakt
    zerst&ouml;ren und in Palenium umwandeln</a>');
}
else
$('#msgarea').html('<font color="#FF0000">Dieses Artefakt kann nicht benutzt werden.</font><br><a
    href="artefacts.php?destroyartefact=1&lid='+a[i].lid+'" onclick="return confirm(\'Artefakt vernichten?\')">Artefakt
    zerst&ouml;ren und in Palenium umwandeln</a>');
}
else if(select==2)
{
...
if(a[id1].id!=a[id2].id)$('#msgarea').html('<font color="#00FF00">Diese beiden Artefakte k&ouml;nnen in ein zuf&auml;lliges
    Artefakt der Stufe 1 verschmolzen werden. Das Zielartefakt wird anderer Art als die Quellartefakte
    sein.</font><br><a href="artefacts.php?mergeartefacts=1&lid1='+a[id1].lid+'&lid2='+a[id2].lid+'"
                       onclick="return confirm(\'Neues Artefakt erzeugen?\')">neues Artefakt erzeugen</a>');
else if(a[id1].level!=a[id2].level)$('#msgarea').html('<font color="#FF0000">Artefakte der gleichen Art, aber mit
    unterschiedlicher Stufe k&ouml;nnen nicht verschmolzen werden.</font>');
else if(a[id1].level==a[id1].maxlevel)$('#msgarea').html('<font color="#FF0000">Diese Artefakte befinden sich bereits
    auf der h&ouml;chsten Stufe.</font>');
else
$('#msgarea').html('<font color="#00FF00">Diese Artefakte k&ouml;nnen zu einem Artefakt der gleichen Art mit einer h&ouml;heren
    Stufe verschmolzen werden.</font><br><a
    href="artefacts.php?mergeartefacts=1&lid1='+a[id1].lid+'&lid2='+a[id2].lid+'">Artefakte fusionieren</a>');
}
else if(select>2)
{
