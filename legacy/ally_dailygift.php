...
include('inc/lang/'.getDefaultVariable('sv_server_lang').'_ally.dailygift.lang.php');
	...
	if(isset($_REQUEST['getdailybonus']) && $_REQUEST['getdailybonus']==1){
		...
		if($row['dailyallygift']==1){
			...
			case 0:
				...
				createAuction($_SESSION['ums_user_id'],getDefaultVariable('sv_deactivate_vsystems'), $ua_name, $db);
				//Auctacon-Artefakt
				/*
				$freeartefactplaces--;
