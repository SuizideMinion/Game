...
//e-mail senden
        if (isset($_REQUEST['feedback'])) {
            ...
            $betreff = 'Feedback: ' . $row['betreff'] . ' ' . getDefaultVariable('sv_server_tag') . ' ' . $ums_user_id . ' ' . $ums_spielername;
            $text = str_replace('\r\n', "\r\n", $_REQUEST['feedback']);
...
//echo '<br><textarea cols="70" rows="10" name="feedback">Trage hier bitte Dein Feedback ein.</textarea>';
        ?>
        <textarea cols="70" rows="10" name="feedback"
                  onfocus="if(this.value == 'Trage hier bitte Dein Feedback ein.') this.value='';"
                  onblur="if (this.value=='') this.value='Trage hier bitte Dein Feedback ein.';">Trage hier bitte Dein Feedback ein.</textarea>
        <?php
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="585">
            <tr>
                ...
                <td align="center" height="35" class="ro">
                    <div class="cellu">A r c h i v</div>
                </td>
                <td width="13" height="25" class="ror"></td>
            </tr>
            <tr>
