...
$submit3 = $_POST['submit3'] ?? null;
$submit4 = $_POST['submit4'] ?? null;
$submit7 = $_POST['submit7'] ?? null;
$submit100 = $_POST['submit100'] ?? null;
$submit101 = $_POST['submit101'] ?? null;
$submit102 = $_POST['submit102'] ?? null;
$submit103 = $_POST['submit103'] ?? null;
$submit104 = $_POST['submit104'] ?? null;
$submit105 = $_POST['submit105'] ?? null;
$submit106 = $_POST['submit106'] ?? null;
$submit107 = $_POST['submit107'] ?? null;
$submit108 = $_POST['submit108'] ?? null;
$submit109 = $_POST['submit109'] ?? null;
$submit110 = $_POST['submit110'] ?? null;
$submit111 = $_POST['submit111'] ?? null;
$submit112 = $_POST['submit112'] ?? null;
$submit113 = $_POST['submit113'] ?? null;
$submit114 = $_POST['submit114'] ?? null;

$remsubmit1 = $_GET['remsubmit1'] ?? null;
$remsubmit2 = $_GET['remsubmit2'] ?? null;
$remsubmit3 = $_GET['remsubmit3'] ?? null;
$remsubmit4 = $_GET['remsubmit4'] ?? null;
$remsubmit100 = $_GET['remsubmit100'] ?? null;
$remsubmit101 = $_GET['remsubmit101'] ?? null;
$remsubmit102 = $_GET['remsubmit102'] ?? null;
$remsubmit103 = $_GET['remsubmit103'] ?? null;
$remsubmit104 = $_GET['remsubmit104'] ?? null;
$remsubmit105 = $_GET['remsubmit105'] ?? null;
$remsubmit106 = $_GET['remsubmit106'] ?? null;
$remsubmit107 = $_GET['remsubmit107'] ?? null;
$remsubmit108 = $_GET['remsubmit108'] ?? null;
$remsubmit109 = $_GET['remsubmit109'] ?? null;
$remsubmit110 = $_GET['remsubmit110'] ?? null;
$remsubmit111 = $_GET['remsubmit111'] ?? null;
$remsubmit112 = $_GET['remsubmit112'] ?? null;
$remsubmit113 = $_GET['remsubmit113'] ?? null;
$remsubmit114 = $_GET['remsubmit114'] ?? null;
    ...
    if (setLock($ums_user_id)) {
        ...
        if ($sm_kartefakt < floor($maxtick / $sm_kartefakt_lz)) {
            if ($credits >= getDefaultVariable('sv_sm_preisliste')[1]) {
                ...
                $errmsg =  ($errmsg ?? '') .'<font color="#FF0000">' . $tradeblackmarketinc_lang['msg_2'] . '</font>';
        } else
            $errmsg =  ($errmsg ?? '') .'<font color="#FF0000">' . $tradeblackmarketinc_lang['msg_3'] . '</font>';
...
/*
if($submit5 && getDefaultVariable('sv_ang')!=1)//dartefakt
{
  //transaktionsbeginn
  if (setLock($ums_user_id))
  {
...
if (isset($errmsg)) echo '<br><div class="info_box">' . $errmsg . '</div>';
...
echo '<tr class="cell" align="center">
  ...
  <br><center></td>
  <td>&nbsp;</td>
  <td>' . getDefaultVariable('sv_sm_preisliste')[2] . ' <img src="' . $ums_gpfad . 'g/credits.gif" title="Credits">
...
echo '<tr class="' . $bg . '" align="center">
  ...
  <td align="left">' . $rembutton . ' ' . $tradeblackmarketinc_lang['msg_17_1'] . '.<br><i>' .
    ...
    '<td>' . getDefaultVariable('sv_sm_preisliste')[6] . ' <img src="' . $ums_gpfad . 'g/credits.gif" title="Credits"><input type="submit" name="submit7" value="' . $tradeblackmarketinc_lang['kaufen'] . '"></td></tr>';
...
echo '<tr class="' . $bg . '" align="center">
  ...
  <td>' . $lzp3 . '</td>
  <td>' . getDefaultVariable('sv_sm_preisliste')[1] . ' <img src="' . $ums_gpfad . 'g/credits.gif" title="Credits"><input type="submit" name="submit2" value="' . $tradeblackmarketinc_lang['kaufen'] . '"></td></tr>';
...
<td>'.$lzp2.'</td>
<td>'.getDefaultVariable('sv_sm_preisliste')[0].' <img src="'.$ums_gpfad.'g/credits.gif" title="Credits"><input type="submit" name="submit1" value="'.$tradeblackmarketinc_lang[kaufen].'"></td></tr>');
...
if(getDefaultVariable('sv_ang')!=1){
  ...
  $lzpdartefakt=$str1.number_format($dartefakt, 0,"",".").'/'.number_format(getDefaultVariable('sv_max_dartefakt'), 0,"",".").$str2;
  ...
  getDefaultVariable('sv_max_dartefakt').' '.$tradeblackmarketinc_lang[msg_19_3].'</td>
  <td>'.$lzpdartefakt.'</td>
  <td>'.getDefaultVariable('sv_sm_preisliste')[4].' <img src="'.$ums_gpfad.'g/credits.gif" title="Credits"><input type="submit" name="submit5" value="'.$tradeblackmarketinc_lang[kaufen].'"></td></tr>');
}
...
{
    return ''; // SUI Braucht den kack nicht!
