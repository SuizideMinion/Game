...
include('inc/lang/' . getDefaultVariable('sv_server_lang') . '_production.lang.php');
include('inc/lang/' . getDefaultVariable('sv_server_lang') . '_defense.lang.php');
...
<head>
    ...
    while ($row = mysqli_fetch_array($db_daten)) { //jeder gefundene datensatz wird geprueft
        ...
        if ($i < 100) {
            ...
            //frachtkapazität
            if (isset($unit[$ums_rasse - 1][$unit_index]['fk']))
...
<body>
<?php
if (isset($_POST['submit']) and $sabotage == 0) {//ja, es wurde ein button gedrueckt
    //transaktionsbeginn
...
<form action="production.php" method="POST" name="produktion">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr height="37px">
            ...
            <td width="51px" align="center" class="ro"><img src="g/icon1.png" style="width: 20px; height: auto;"
                                                            title="Multiplex"></td>
            <td width="51px" align="center" class="ro"><img src="g/icon2.png" style="width: 20px; height: auto;"
                                                            title="Dyharra"></td>
            <td width="51px" align="center" class="ro"><img src="g/icon3.png" style="width: 20px; height: auto;"
                                                            title="Iradium"></td>
            <td width="51px" align="center" class="ro"><img src="g/icon4.png" style="width: 20px; height: auto;"
                                                            title="Eternium"></td>
            <td width="31px" align="center" class="ro"><img src="g/icon5.png" style="width: 20px; height: auto;"
                                                            title="Tronic"></td>
            ...
            <td colspan="9">
                <table border="0" cellpadding="0" cellspacing="1" width="100%">
                    ...
                    while ($row = mysqli_fetch_array($db_daten)) {
                        for ($i = 81; $i <= 90; $i++) {
                            if (!isset($ec[$i])) {
                                $ec[$i] = 0; // Initialisiere den Schlüssel
                            }
                            $ec[$i] += $row['e' . $i];
                        }
                    }
        ...
        <table border="0" cellpadding="1" cellspacing="1">
            ...
            <tr height="20">
                <td class="cell" colspan="8" align="center"><input type="Submit" name="submit"
                                                                   value="<?= $production_lang['bauen'] ?>"></td>
            </tr>
        </table>
        <?php
