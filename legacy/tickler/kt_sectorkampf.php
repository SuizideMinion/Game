...
function create_bknachricht(){
	global $kt_lang, $sumatter, $ueatter, $sumdeffer, $uedeffer, $eigeninsg, $eigenue, $zsec, $astr, $dstr, $sec_id, $stolestr, $db, getDefaultVariable('sv_maxsystem');
	...
	//echo '<br>Sektorkampf-SK: '.$bk.'/'.$sec_id.'/'.getDefaultVariable('sv_maxsystem');
