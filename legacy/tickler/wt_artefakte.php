...
for($k=11;$k<=20;$k++){
	...
	for ($i=0; $i<$num; $i++){
		...
		//bonusressourcen durch die gabe. getDefaultVariable('sv_kollieertrag_pa') wird hier nicht mehr genutzt
		$ea=$col*getDefaultVariable('sv_kollieertrag')/100*$sv_artefakt[$k-1][0];
