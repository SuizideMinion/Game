...
$einheitentypen=array('Jäger','Jagdboot','Zerstörer','Kreuzer','Schlachtschiff','Bomber','Transmitterschiff', 'Träger', 'Jägergarnison', 'Raketenturm',
'Laserturm', 'Autokanonenturm', 'Plasmaturm');
...
{
	//einheitentyp
	echo '<tr style="background-color: #DDDDDD;"><td>'.$einheitentypen[$e].'</td><td>E</td><td>I</td><td>K</td><td>Z</td><td>D</td></tr>';
