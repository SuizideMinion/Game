...
if((strftime("%M"))==0 AND (strftime("%H"))==19 OR $erhabenenstop==1)
{
  ...
  $server_v35=round(median($votes[35]));
    ...
    $str.='getDefaultVariable('sv_inactiv_deldays')='.$server_v5.';'."\n\n";
	  $str.='getDefaultVariable('sv_attgrenze')='.($server_v6/100).';'."\n\n";
    $str.='getDefaultVariable('sv_sector_attmalus')='.($server_v7/100).';'."\n\n";
    $str.='getDefaultVariable('sv_max_col_attgrenze')='.($server_v8/100).';'."\n\n";
    $str.='getDefaultVariable('sv_min_col_attgrenze')='.($server_v9/100).';'."\n\n";
    $str.='getDefaultVariable('sv_ps_bonus')='.$server_v10.';'."\n\n";
    $str.='getDefaultVariable('sv_recyclotron_bonus')='.$server_v11.';'."\n\n";
    $str.='getDefaultVariable('sv_recyclotron_bonus_whg')='.$server_v12.';'."\n\n";
    $str.='getDefaultVariable('sv_kollie_klaurate')='.($server_v13/100).';'."\n\n";
    $str.='getDefaultVariable('sv_kollieertrag')='.$server_v14.';'."\n\n";
    $str.='getDefaultVariable('sv_kollieertrag_pa')='.$server_v15.';'."\n\n";
    $str.='getDefaultVariable('sv_kriegsartefaktertrag')='.$server_v16.';'."\n\n";
    $str.='getDefaultVariable('sv_kartefakt_exp_atter')='.$server_v17.';'."\n\n";
    $str.='getDefaultVariable('sv_kartefakt_exp_deffer')='.$server_v18.';'."\n\n";
    $str.='getDefaultVariable('sv_max_palenium')='.$server_v19.';'."\n\n";
    $str.='getDefaultVariable('sv_bounty_rate')='.($server_v20/100).';'."\n\n";
    ...
    if($erhabenenstop==1){
      ...
      {
        $str.='getDefaultVariable('sv_deactivate_sec1moveout')=0;'."\n\n";
        $str.='getDefaultVariable('sv_max_secmoves')=0;'."\n\n";
      }
      else //wahl
      {
        $str.='getDefaultVariable('sv_deactivate_sec1moveout')=1;'."\n\n";
        $str.='getDefaultVariable('sv_max_secmoves')=999;'."\n\n";
      }

      //spieler pro sektor
      $str.='getDefaultVariable('sv_maxsystem')='.$server_v23.';'."\n\n";
      $str.='getDefaultVariable('sv_max_user_per_regsector')='.$server_v23.';'."\n\n";

      //maximale sektoranzahl
      //dafür wird die anzahl von aktiven spielern für die berechnung benötigt
      $str.='getDefaultVariable('sv_maxsector')='.ceil(($anz*1.1/$server_v23)+1).';'."\n\n";

      $str.='getDefaultVariable('sv_deactivate_trade')='.$server_v24.';'."\n\n";
      ...
      $str.='getDefaultVariable('sv_max_user_per_regsector')='.getDefaultVariable('sv_max_user_per_regsector').';'."\n\n";
      $str.='getDefaultVariable('sv_maxsector')='.getDefaultVariable('sv_maxsector').';'."\n\n";


      $str.='getDefaultVariable('sv_deactivate_trade')='.getDefaultVariable('sv_deactivate_trade').';'."\n\n";
