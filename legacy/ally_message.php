...
include('inc/lang/' . getDefaultVariable('sv_server_lang') . '_ally.message.lang.php');
...
function insertmessage($message, $color, $allymessage_lang)
{
...
<font face="tahoma" style="font-size:8pt;">
    ...
    if ($action == "del") {//nachricht l&ouml;schen
        ...
        echo insertmessage($allymessage_lang['msg_1'], "g", $allymessage_lang);
    }
    ...
    if ($ak || $deak) {//HFNs direkt weiterleiten?
        ...
        if ($ak) echo insertmessage($allymessage_lang['msg_2'], "g", $allymessage_lang);
        if ($deak) echo insertmessage($allymessage_lang['msg_3'], "r", $allymessage_lang);
    }
    ...
    if ($action == "fw") {
        ...
        mysql_query("DELETE FROM de_hfn_usr_ally WHERE allytag='$allytag' and fromsec='$se' and  fromsys='$sy' and time='$t'", $db);
        echo insertmessage($allymessage_lang['msg_4'], "g", $allymessage_lang);
    ...
    if ($send) {
        ...
        echo insertmessage($allymessage_lang['msg_5'], "g", $allymessage_lang);
        ...
        <form method="POST" action="ally_message.php">
            ...
            <table border="0" width="600px" cellspacing="1" cellpadding="0">
                ...
                <tr class="tc">
                    <td width="50%" height="21" colspan=2><input type="submit"
                                                                 value="<?php echo $allymessage_lang['abschicken']; ?>"
                                                                 name="send"><input type="reset"
                                                                                    value="<?php echo $allymessage_lang['zurueck']; ?>"
                                                                                    name="B2"></td>
                </tr>
            </table>
        </form>
        ...
        <table border="0" width="400" cellspacing="2" cellpadding="0">
            ...
            if ($num == "0") {
                ...
                while ($hfnrow = mysql_fetch_array($db_memhfnmem)) {
                    ...
                    <tr>
                        <td width="50" class="cell">&nbsp;<b><?php echo $allymessage_lang['absender']; ?></b></td>
                        <td class="cell1"><font face="Times New Roman"
                                                size="2">&nbsp;<?php echo $hfnrow['fromsec'] . ':' . $hfnrow['fromsys'] . ' (' . $hfnrow['fromnic'] . ')'; ?></font>
                        </td>
                    </tr>
                    <tr>
                        <td class="cell1">&nbsp;<b><?php echo $allymessage_lang['datum']; ?></b></td>
                        <td class="cell">&nbsp;<?php echo $time; ?></td>
                    </tr>
                    <tr>
                        <td class="cell">&nbsp;<b><?php echo $allymessage_lang['betreff']; ?></b></td>
                        <td class="cell1">&nbsp;<?php echo $hfnrow['betreff']; ?></td>
                    </tr>
                    <tr>
                        <td valign="top" class="cell1">&nbsp;<b><?php echo $allymessage_lang['nachricht']; ?></b></td>
                        <td class="cell">&nbsp;<?php echo $hfnrow['text']; ?></td>
                    </tr>
