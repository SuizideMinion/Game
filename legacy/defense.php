...
<head>
    ...
    $c1 = 0;
    $i = 81 + getDefaultVariable('sv_anz_schiffe');
    unset($tooltips);
...
<form action="defense.php" method="POST" name="produktion">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr height="37">
            ...
            <td width="208" class="ro">
                <div class="cellu">&nbsp;&nbsp;<?= $defense_lang['einheit'] ?>:</div>
            </td>
            <td width="50" align="center" class="ro">
                <div class="cellu">M</div>
            </td>
            <td width="50" align="center" class="ro">
                <div class="cellu">D</div>
            </td>
            <td width="50" align="center" class="ro">
                <div class="cellu">I</div>
            </td>
            <td width="50" align="center" class="ro">
                <div class="cellu">E</div>
            </td>
            <td width="27" align="center" class="ro">
                <div class="cellu">T</div>
            </td>
            <td width="33" align="center" class="ro">
                <div class="cellu"><?= $defense_lang['wochen'] ?></div>
            </td>
            <td width="50" align="center" class="ro">
                <div class="cellu"><?= $defense_lang['stueck'] ?></div>
            </td>
            <td width="50" align="center" class="ro">
                <div class="cellu"><?= $defense_lang['bauen'] ?></div>
            </td>
