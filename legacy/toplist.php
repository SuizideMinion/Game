...
include 'inc/lang/' . getDefaultVariable('sv_server_lang') . '_toplist.lang.php';
...
echo '<td width="50%"><a href="toplist.php?s=1"><img src="' . $ums_gpfad . 'g/' . getDefaultVariable('sv_server_lang') . '_tl1.gif" border="0"></a></td>';
echo '<td width="50%"><a href="toplist.php?&s=2"><img src="' . $ums_gpfad . 'g/' . getDefaultVariable('sv_server_lang') . '_tl2.gif" border="0"></a></td>';
echo '</tr>';
echo '<tr align="center">';
echo '<td><a href="toplist.php?&s=3"><img src="' . $ums_gpfad . 'g/' . getDefaultVariable('sv_server_lang') . '_tl3.gif" border="0"></a></td>';
echo '<td><a href="toplist.php?&s=4"><img src="' . $ums_gpfad . 'g/' . getDefaultVariable('sv_server_lang') . '_tl4.gif" border="0"></a></td>';
echo '</tr>';
echo '</table>';
echo '</div><br>';
...
//sektorenrangliste
///////////////////////////////////
if (isset($_REQUEST['s']) AND $_REQUEST['s'] == 2) {
...
//handel
///////////////////////////////////
if (isset($_REQUEST['s']) AND $_REQUEST['s'] == 4) {
...
if (!isset($_REQUEST['s'])) {
    ...
    if (getDefaultVariable('sv_ewige_runde') == 1) {
        ...
        echo '<tr class="cell1" align="center">
		  ...
		  <td>' . number_format(getDefaultVariable('sv_credit_win')[0][0], 0, "", ".") . '</td>
		  <td>' . number_format(getDefaultVariable('sv_credit_win')[0][1], 0, "", ".") . '</td>
		  <td>' . number_format(getDefaultVariable('sv_credit_win')[0][2], 0, "", ".") . '</td>
		</tr>';
        ...
        if (getDefaultVariable('sv_deactivate_trade') == 0)
		  ...
		  <td>' . number_format(getDefaultVariable('sv_credit_win')[1][0], 0, "", ".") . '</td>
		  <td>' . number_format(getDefaultVariable('sv_credit_win')[1][1], 0, "", ".") . '</td>
		  <td>' . number_format(getDefaultVariable('sv_credit_win')[1][2], 0, "", ".") . '</td>
		</tr>';

        /*
        echo '<tr class="cell1" align="center">
          <td align="left">'.$toplist_lang[spieler].' -> '.$toplist_lang[kopfgeldjaeger].' -> '.$toplist_lang[gesamtwert].'</td>
          <td>'.number_format(getDefaultVariable('sv_credit_win')[2][0], 0,"",".").'</td>
          <td>'.number_format(getDefaultVariable('sv_credit_win')[2][1], 0,"",".").'</td>
          <td>'.number_format(getDefaultVariable('sv_credit_win')[2][2], 0,"",".").'</td>
        </tr>';
        */
        /*
        echo '<tr class="cell" align="center">
          <td align="left">'.$toplist_lang[cyborg].' -> '.$toplist_lang[punkte].'</td>
          <td>'.number_format(getDefaultVariable('sv_credit_win')[3][0], 0,"",".").'</td>
          <td>'.number_format(getDefaultVariable('sv_credit_win')[3][1], 0,"",".").'</td>
          <td>'.number_format(getDefaultVariable('sv_credit_win')[3][2], 0,"",".").'</td>
        </tr>';
        */
        ...
        echo '<tr class="cell" align="center">
		  ...
		  <td colspan="3">' . number_format(getDefaultVariable('sv_credit_win')[4][0], 0, "", ".") . '</td>
		</tr>';
