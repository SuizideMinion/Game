...
include('inc/lang/' . getDefaultVariable('sv_server_lang') . '_vote.lang.php');
...
//                }
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="500">
            <tr height="37" align="center">
                <td class="rol">&nbsp;</td>
                <td class="ro">
                    <div class="cellu"><?php echo $vote_lang['alteumfragen']; ?></div>
                </td>
                <td class="ror">&nbsp;</td>
            </tr>
        ...
        if (mysql_num_rows($db_checkobende) > 0) {
            ...
            <a href="javascript:history.back()">
                <div class="cellu"><b><?php echo $vote_lang['zzu']; ?></b></div>
            </a>
            <br><br>
            <table border="0" cellpadding="0" cellspacing="0" width="600">
                <tr height="37" align="center">
                    <td class="rol">&nbsp;</td>
                    <td class="ro" colspan="1">
                        <div class="cellu"><?php echo utf8_encode($row['frage']); ?></div>
                    </td>
                    <td class="ror">&nbsp;</td>
                </tr>
                <tr height="20">
                    ...
                    <td>
                        ...
                        <table border="0" width="100%" cellspacing="2" cellpadding="0">
                            ...
                            <tr height="20">
                                <td class="cell" cellspacing="2">&nbsp;<?php $vote_lang['start']; ?>
                                    : <?php echo str_replace(" ", "&nbsp;&nbsp;/&nbsp;&nbsp;", $row['startdatum']); ?></td>
                            ...
                            <tr height="25">
                                <td class="cell">&nbsp;<?php echo $vote_lang['ende']; ?>
                                    : <?php echo str_replace(" ", "&nbsp;&nbsp;/&nbsp;&nbsp;", $row['enddatum']); ?></td>
                                <td cellspacing="2" class="cell">&nbsp;</td>
                            </tr>

                            <tr height="25">
                                <td colspan="4" class="cell">&nbsp;<?php echo utf8_encode($vote_lang['hinweis']); ?>
                                    : <?php echo nl2br(utf8_encode($row['hinweis'])); ?></td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <table border="0" width="100%" cellspacing="2" cellpadding="0">
                               ...
                               <td height="25">&nbsp;' . utf8_encode($antworten[$i]) . '</td><td>&nbsp;';
                                            ...
                                            ?>
                                            <img src="<?php echo $ums_gpfad; ?>g/vote/l<?php echo $farbe; ?>.gif"
                                                 border="0"><img
                                                src="<?php echo $ums_gpfad; ?>g/vote/m<?php echo $farbe; ?>.gif"
                                                border="0" width="<?php echo $prozente; ?>" height="9"><img
                                                src="<?php echo $ums_gpfad; ?>g/vote/r<?php echo $farbe; ?>.gif">
                                            <?php
