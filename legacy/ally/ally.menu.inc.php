<?php
include base_path() . '/legacy/' . '/inc/lang/' . (getDefaultVariable('sv_server_lang') ?? 1) . '_ally.menu.lang.php';
//dd($allymenu_lang);
...
function has_position($position, $allytag, $userid, $db)
{
    $has_position = false;
...
function print_LEADER_ally_bar($ums_gpfad, $ums_rasse, $allymenu_lang)
{
...
function print_COLEADER_ally_bar($ums_gpfad, $ums_rasse, $allymenu_lang)
{
    print("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" class=\"cell\">
				<tr align=\"center\">
					<td><a href=\"allymain.php\" class=\"btn\">" . $allymenu_lang['allgemein'] . "</a></td>
...
function print_MEMBER_ally_bar($ums_gpfad, $ums_rasse, $allymenu_lang)
{
    print("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" class=\"cell\">
				<tr align=\"center\">
					<td><a href=\"allymain.php\" class=\"btn\">" . $allymenu_lang['allgemein'] . "</a></td>
...
function print_NOBODY_ally_bar($db, $ums_gpfad, $ums_rasse, $allymenu_lang, $ums_user_id, $ums_spielername)
{
//	global $db, $ums_gpfad, $ums_rasse, $allymenu_lang, $ums_user_id, $ums_spielername;
    ...
    if ($num > 0)//man hat sich beworben
    {
        ...
        if (isset($_REQUEST['stornobewerbung'])) {
            //allianz informieren
