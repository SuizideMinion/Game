...
$sn_lang['mailhallo']='Hallo $ums_spielername,\n\nmit dieser Mail bekommst du deine Angeforderten Systemnachrichten vom Server: '. getDefaultVariable('sv_server_name') .'\n\n\n\n';
...
$sn_lang['mailbetreff']='Die Ewigen - Nachrichten Server '. getDefaultVariable('sv_server_name');
