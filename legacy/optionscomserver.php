...
else //einstellungsmöglichkeiten anzeigen
{
  ...
  <br>Tageswert: '.getDefaultVariable('sv_winscore').' - Aktuelle Abstimmung: '.$server_v3.' - Deine Wahl: <input type="number" min="5000" max="70000" name="v3" value="'.$playervalues['v3'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_benticks').' - Aktuelle Abstimmung: '.$server_v4.' - Deine Wahl: <input type="number" min="480" max="2880" name="v4" value="'.$playervalues['v4'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_inactiv_deldays').' - Aktuelle Abstimmung: '.$server_v5.' - Deine Wahl: <input type="number" min="3" max="10" name="v5" value="'.$playervalues['v5'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.(getDefaultVariable('sv_attgrenze')*100).'% - Aktuelle Abstimmung: '.$server_v6.'% - Deine Wahl: <input type="number" min="10" max="70" name="v6" value="'.$playervalues['v6'].'" size="10" maxlength="10">%
  </div>';
  ...
  <br>Tageswert: '.(getDefaultVariable('sv_sector_attmalus')*100).'% - Aktuelle Abstimmung: '.$server_v7.'% - Deine Wahl: <input type="number" min="1" max="40" name="v7" value="'.$playervalues['v7'].'" size="10" maxlength="10">%
  </div>';
  ...
  <br>Tageswert: '.(getDefaultVariable('sv_max_col_attgrenze')*100).'% - Aktuelle Abstimmung: '.$server_v8.'% - Deine Wahl: <input type="number" min="1" max="70" name="v8" value="'.$playervalues['v8'].'" size="10" maxlength="10">%
  </div>';
  ...
  <br>Tageswert: '.(getDefaultVariable('sv_min_col_attgrenze')*100).'% - Aktuelle Abstimmung: '.$server_v9.'% - Deine Wahl: <input type="number" min="1" max="40" name="v9" value="'.$playervalues['v9'].'" size="10" maxlength="10">%
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_ps_bonus').'% - Aktuelle Abstimmung: '.$server_v10.'% - Deine Wahl: <input type="number" min="1" max="20" name="v10" value="'.$playervalues['v10'].'" size="10" maxlength="10">%
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_recyclotron_bonus').'% - Aktuelle Abstimmung: '.$server_v11.'% - Deine Wahl: <input type="number" min="1" max="30" name="v11" value="'.$playervalues['v11'].'" size="10" maxlength="10">%
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_recyclotron_bonus_whg').'% - Aktuelle Abstimmung: '.$server_v12.'% - Deine Wahl: <input type="number" min="1" max="60" name="v12" value="'.$playervalues['v12'].'" size="10" maxlength="10">%
  </div>';
  ...
  <br>Tageswert: '.(getDefaultVariable('sv_kollie_klaurate')*100).'% - Aktuelle Abstimmung: '.$server_v13.'% - Deine Wahl: <input type="number" min="5" max="25" name="v13" value="'.$playervalues['v13'].'" size="10" maxlength="10">%
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_kollieertrag').' - Aktuelle Abstimmung: '.$server_v14.' - Deine Wahl: <input type="number" min="50" max="150" name="v14" value="'.$playervalues['v14'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_kollieertrag_pa').' - Aktuelle Abstimmung: '.$server_v15.' - Deine Wahl: <input type="number" min="50" max="165" name="v15" value="'.$playervalues['v15'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_kriegsartefaktertrag').' - Aktuelle Abstimmung: '.$server_v16.' - Deine Wahl: <input type="number" min="50" max="150" name="v16" value="'.$playervalues['v16'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_kartefakt_exp_atter').' - Aktuelle Abstimmung: '.$server_v17.' - Deine Wahl: <input type="number" min="3000" max="7000" name="v17" value="'.$playervalues['v17'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_kartefakt_exp_deffer').' - Aktuelle Abstimmung: '.$server_v18.' - Deine Wahl: <input type="number" min="3000" max="7000" name="v18" value="'.$playervalues['v18'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.getDefaultVariable('sv_max_palenium').' - Aktuelle Abstimmung: '.$server_v19.' - Deine Wahl: <input type="number" min="10" max="400" name="v19" value="'.$playervalues['v19'].'" size="10" maxlength="10">
  </div>';
  ...
  <br>Tageswert: '.(getDefaultVariable('sv_bounty_rate')*100).'% - Aktuelle Abstimmung: '.$server_v20.'% - Deine Wahl: <input type="number" min="1" max="20" name="v20" value="'.$playervalues['v20'].'" size="10" maxlength="10">%
  </div>';
  */
  ...
  if(getDefaultVariable('sv_max_secmoves')==0)$rundentyp='Zufall';else $rundentyp='Wahl';
  ...
  <br>Aktuelle Runde: '.getDefaultVariable('sv_maxsystem').' - Aktuelle Abstimmung: '.$server_v23.' - Deine Wahl: <input type="number" min="1" max="20" name="v23" value="'.$playervalues['v23'].'" size="10" maxlength="10">
  </div>';

  //handel aktiv
  if ($c1==0){$c1=1;$bg='cell';}else{$c1=0;$bg='cell1';}
  if($server_v24<=0.5)$rundenwahl='ja';else $rundenwahl='nein';
  if(getDefaultVariable('sv_deactivate_trade')==0)$rundentyp='ja';else $rundentyp='nein';
