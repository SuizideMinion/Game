...
include 'inc/lang/'.getDefaultVariable('sv_server_lang').'_ally.scan.lang.php';
...
if (has_position("leaderid", $clankuerzel, $ums_user_id, $db) || has_position("coleaderid1", $clankuerzel, $ums_user_id) || has_position("coleaderid2", $clankuerzel, $ums_user_id) || has_position("coleaderid3", $clankuerzel, $ums_user_id) || has_position("tacticalofficer1", $clankuerzel, $ums_user_id) || has_position("leaderid", $clankuerzel, $ums_user_id))
{
	$full_access = true;
}
