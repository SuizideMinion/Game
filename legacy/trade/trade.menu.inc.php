...
//08.02.2010 link zum konfigurationsmen� ausgebaut, da ca. 5 jahre ohne funktion
//16.02.2010 html-code �berarbeitet und neues buttondesign integriert

include 'inc/lang/'.getDefaultVariable('sv_server_lang').'_trade.menu.lang.php';
