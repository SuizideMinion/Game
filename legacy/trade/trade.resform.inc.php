...
<?PHP
include 'inc/lang/'.getDefaultVariable('sv_server_lang').'_trade.resform.lang.php';
	...
	else
	{
		...
		if ($restype != "m")
		{
			generateResline($restype, "m", $ums_user_id, $traderesform_lang, getDefaultVariable('sv_server_lang'));
		}
		if ($restype != "d")
		{
			generateResline($restype, "d", $ums_user_id, $traderesform_lang, getDefaultVariable('sv_server_lang'));
		}
		if ($restype != "i")
		{
			generateResline($restype, "i", $ums_user_id, $traderesform_lang, getDefaultVariable('sv_server_lang'));
		}
		if ($restype != "e")
		{
			generateResline($restype, "e", $ums_user_id, $traderesform_lang, getDefaultVariable('sv_server_lang'));
		}
		print("</table>");
	...
	function generateResline($res, $currency, $user_id, $traderesform_lang, getDefaultVariable('sv_server_lang'))
	{
