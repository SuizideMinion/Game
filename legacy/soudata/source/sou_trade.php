...
if($num==1){
	...
	//geb�udelevel des handelskontors auslesen
	...
	if($geb_level>0){
		...
		///////////////////////////////////////////////////////
		///////////////////////////////////////////////////////
		//  f�r x minuten im asteroidenfeld minen und das dann direkt verkaufen
		///////////////////////////////////////////////////////
		///////////////////////////////////////////////////////
		if($_REQUEST["do"]=='2'){
		  //transaktionsbeginn
			...
			if($freehold>0){
				...
				if($canmine>0){
					...
					if($has_credits>=$needcredits){
					  //�berpr�fen ob man diese rohstoffart dort bereits verkaufen kann
					  if($geb_level>=$r_def[$rid][3])
					  {
						...
						if(res_is_available($rid)==1)
						{
						  ...
						  //berechnen wieviel geld man f�r die rohstoffe bekommt und diese gutschreiben
    ...
    for($i=0;$i<1;$i++)
	{
  	  ...
  	  //rohstoffname
  	  if($geb_level<$r_def[$i][3])$resname='<font color="#FF0000">'.$r_def[$i][0].' (ab Geb�udestufe '.$r_def[$i][3].')</font>';
