...
if($num==1)
{
  ...
  //�berpr�fen ob das system umk�mpft ist
  ...
  //alle geb�ude im system auslesen
  unset($b_has);
  $geb_durchschnitt=0;
  ...
  //alle geb�ude-upgrade-module auslesen
  unset($um_has);
  ...
  ////////////////////////////////////////////////////
  ////////////////////////////////////////////////////
  //levelrohstoffeinzahlung f�r max 60/480 minuten
  ////////////////////////////////////////////////////
  ////////////////////////////////////////////////////
  if($_REQUEST["do"]=='1')
  {
	  ...
	  if($ums_premium==1)$min=480;else $min=60;
  	  ...
  	  if($freehold>0)
  	  {
    		...
    		for($n=0;$n<count($need);$n++)
    		{
 			...
 			if($benres>0){
				//dem geb�ude die rohstoffe gutschreiben
				...
				//�berpr�fen wie oft er fliegen mu�
				...
				//credits abziehen
				if($needcredits>0)change_credits($ums_user_id, $needcredits*(-1), 'Geb�ude-Komfortfunktion');
				...
				//fraktionsansehen und systemwert vergr��ern
  ...
  ////////////////////////////////////////////////////
  ////////////////////////////////////////////////////
  //rohstoffeinzahlung f�r x minuten
  ////////////////////////////////////////////////////
  ////////////////////////////////////////////////////
  if($_REQUEST["do"]=='2'){
    //transaktionsbeginn
          ...
          $has_credits=has_credits($ums_user_id);
    		...
    		for($n=0;$n<count($need);$n++)
    		{
 			...
 			if($benres>0){
			  ...
			  //�berpr�fen wie oft er fliegen mu�, er fliegt jetzt immer solange, wie angegeben
  ...
  if($_REQUEST["do"]=='3'){
    ...
    if (setLock($_SESSION["sou_user_id"])){
	  ...
	  //�berpr�fen ob man das passende modul auch hat
  	  if($um_has[$blevel]>0)
  	  {
  ...
  */
  ...
  for($i=0;$i<count($b_defs);$i++)
  {
    ...
    */
    ...
    //ab level 10 ben�tigt man x geb�ude in der gesamten fraktion
    //ab level 10 ben�tigt man x sonnensysteme
    if($level>=10){
      /////////////////////////////////////////////////////
      /////////////////////////////////////////////////////
      //geb�ude
      ...
      //$needgebs=($level-9)*2+1;//+1 f�r das geb�ude im system selbst
      $needgebs=ceil(($level-9)*($level-9)/4)+1;//+1 f�r das geb�ude im system selbst
      ...
      /////////////////////////////////////////////////////
      /////////////////////////////////////////////////////
      //sonnensysteme, gilt nur f�r konstruktionszentrum
      /////////////////////////////////////////////////////
      /////////////////////////////////////////////////////
      if($i==0)
      {
    ...
    //koloniedurchschnitt, gilt nur f�r konstruktionszentrum
    if($i==0)
    {
    ...
    for($n=0;$n<count($need);$n++){
	  ...
	  //die aktuellen kosten f�r den sp�teren Abzug speichern
	  $res_abzug[$n]=$einzelneed[0];

      //fix f�r die komfortfunktion, falls zuviele rohstoffe vorhanden sind
      //if($b_has[$i][1][$n]>$einzelneed[0])$b_has[$i][1][$n]=$einzelneed[0];

      //eingabefeld f�r rohstoffe, falls man nicht am max ist
	...
	//wenn der ausbaubutton gedr�ckt wurde das geb�ude direkt ausbauen
	if($hasall==1 AND $_REQUEST["do"]=="build" AND $_REQUEST["bid"]==($i+1))
	{
      ...
      if($num==1){
        //upgraden und die ben�tigten Rohstoffe abziehen
        $time=time();
        ...
        //meldung f�r den chat hinzuf�gen
    ...
    //wenn alles vorhanden ist, dann button f�r den ausbau anzeigen
    ...
    //wenn nicht alles vorhanden ist �berpr�fen ob er evtl. nen geb�udeupgrademodul hat
