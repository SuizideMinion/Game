...
if(getDefaultVariable('sv_sou_in_de'))$jsstr.='<br><br>Um den t&auml;glichen (01:00 Uhr) Bonus zu erhalten, mu&szlig; Dein heutiges Spendenvolumen, nach den aktuellen Werten, folgenden Wert erreichen: '.number_format(round($jahrespenden/$durchschnitt/2), 0,"",".");
