...
if(getDefaultVariable('sv_sou_in_de')==1 AND $_SESSION['ums_mobi']==1)
{
...
//if(getDefaultVariable('sv_sou_in_de')==1)echo '<div style="position: absolute; top: 0px; right: 0px; z-index: 10000;" title="zur&uuml;ck zu DE"><a href="javascript:void(0);"onclick="javascript:'.$qlstr.'"><img border="0" src="'.$gpfad.'delogo.jpg" width="48px" height="48px"></a></div>';

//tooltips f�r die seite
echo '<SCRIPT language="JavaScript1.2" >';
//back-to-de-code
if(getDefaultVariable('sv_sou_in_de')==1)echo 'function btde(){'.$qlstr.'}';
echo '</SCRIPT>';
...
if(getDefaultVariable('sv_payserver')==1)
{
  if($ums_premium==0)
  {
  	echo '<br>';
