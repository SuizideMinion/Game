...
if($_REQUEST['loadinfobar1']==1)
{
  ...
  .getDefaultVariable('sv_server_tag').' - F'.$player_fraction.' - '.umlaut($player_name).' ('.$player_x.':'.$player_y.')'
  ...
  if(getDefaultVariable('sv_sou_in_de')==1)$output.='<span style="position: absolute; margin-top: 3px; right: 3px; cursor: pointer;" onClick="btde();"><img src="'.$gpfad.'backtode.png" alt="zur&uuml;ck zu DE" title="zur&uuml;ck zu DE"></span>';
