...
//�berpr�fen ob man sich in einem sonnensystem der eigenen fraktion mit hyperraumblase befindet
$system1hb=0;
...
/////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////
//�berpr�fen ob man eine srb bauen m�chte
/////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////
if($_REQUEST["buildbase"]==1)
{
	...
	//�berpr�fen ob eine srb baubar ist: keine sonnensystem und keine andere srb d�rfen vorhanden sein
	if($anzahl_sonnensysteme==0 AND $anzahl_srb==0)
	{
		//�berpr�fen ob der nachbarsektor einen bau erm�glicht
	...
	{
	  //�berpr�fen ob man eine aktion bzlg. timer1 durchf�hren kann
	  if($player_atimer1time<time())
	  {
  	    ...
  	    if (setLock($_SESSION["sou_user_id"]))
  	    {
  		  ...
  		  if($hasmoney>=$spende)
  		  {
			//�berpr�fen ob man im sektor ist
...
if($_GET["tx"]!='' AND$_GET["ty"]!='')
{
  ...
  if($player_atimer1time<time())
  {
    $tx=(int)$_GET["tx"];
    $ty=(int)$_GET["ty"];
    //�berpr�fen ob der zielsektor bekannt ist
	...
	if($num==1)
	{
      ...
      //�berpr�fen ob ggf. eine reise per hyperraumblase besser ist
	  $hashblevel=0;
	  $targethblevel=0;
      ...
      if($reichweite>0)
      {
        ...
        {
          //reichweitenbeschr�nkung der hyperraumblasenreise �berpr�fen
          if($w3<5000)
          {
          	//�berpr�fen ob die neuen koordinaten sich auch woanders befinden
...
if(isset($_REQUEST['ex']) AND isset($_REQUEST['ey']) AND isset($_REQUEST['ecost']))
{
  ...
  //�berpr�fen ob sich der spieler im nachbarsektor aufh�lt
  ...
  if($isthere==1)
  {
    //�berpr�fen ob eine expedition bzgl. nachbarsektor m�glich ist
    ...
    {
      //�berpr�fen ob der sektor evtl. schon erforscht worden ist
      ...
      if($anzahl_known==0)
      {
	    ...
	    else //die expeditionskosten f�r den sektor aus der fraktionskasse bezahlen
	    {
	      $needmoney=$gesamtkosten;
        ...
        if($erforscht==1)
        {
          //datensatz f�r den sektor anlegen
          $time=time();
...
//man kommt von der strategischen karte, oder einer anderen seite die koordinaten �bergibt
...
if($player_rhuse==1)
{
  ...
  //tooltip f�r die reisehilfe bauen
  if($player_rhuse==1)
  {
...
//buttons f�r schiff/system/strategische Karte
echo '
