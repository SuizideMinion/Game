...
include basePath('inc/lang/' . getDefaultVariable('sv_server_lang') . '_resline.lang.php');
...
if (isset($show_activetime_msg) && $show_activetime_msg == 1) {
    $nexttime = time() + getDefaultVariable('sv_activetime');
...
if (getDefaultVariable('sv_ang') == 1 && $_SESSION['ums_mobi'] != 1 && $_SESSION['de_frameset'] != 1) {
    if (!$flag_ang_big_iframe) {
