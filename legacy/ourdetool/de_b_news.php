...
echo '<br><br><h1>Nachricht erfolgreich gel�scht</h1><br><br>';
}
...
echo '<form action="de_b_news.php?id='.$id.'" method="post" >
  <table border="1">
  <tr>
    <td colspan="2" align="center"><b>News �ndern</b></td>
  </tr>
  <tr>
    <td>Betreff:</td>
