...
if ($button)
{
  ...
  if ($zsector<1 OR $zsector>getDefaultVariable('sv_show_maxsector'))$fehlermsg.='<font color="#FF0000">Die Sektorgr��e ist ung�ltig.</font><br>';
  if ($zsystem<1 OR $zsystem>99)$fehlermsg.='<font color="#FF0000">Die Systemgr��e ist ung�ltig.</font><br>';
