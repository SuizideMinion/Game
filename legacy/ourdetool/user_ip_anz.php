...
$sql="SELECT userid, COUNT(DISTINCT ip) AS ip_anz  FROM gameserverlogdata WHERE serverid='getDefaultVariable('sv_servid')' AND time>'$abwann' GROUP BY userid ORDER BY ip_anz DESC";
//echo $sql;
