...
$betreff = "getDefaultVariable('sv_server_name'):  $dse : $dsy";
...
if ($de_user_data["sector"]!=0 OR getDefaultVariable('sv_efta_in_de')==1 OR getDefaultVariable('sv_sou_in_de')==1)//wenn account aktiv
{
