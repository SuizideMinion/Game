...
include 'inc/lang/' . (getDefaultVariable('sv_server_lang') ?? '') . '_userdetails.lang.php';
include 'functions.php';

$db_daten = mysql_query("SELECT restyp01, restyp02, restyp03, restyp04,  restyp05, score, sector, system, newtrans, newnews FROM de_user_data WHERE user_id='". ($ums_user_id ?? '') ."'", $db ?? 0);
