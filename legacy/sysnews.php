...
include basePath('inc/lang/' . getDefaultVariable('sv_server_lang') . '_sysnews.lang.php');
...
<head>
    ...
    echo '<title>' . $sn_lang["alle"] . ' ' . $sn_lang["nachrichten"] . '</title>';
    ?>
...
if (isset($_GET['a']) and $_GET["a"] == "d") {//alle nachricht l&ouml;schen
...
<form action="sysnews.php" method="POST">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr height="37">
            <td width="13" height="37" class="rol">&nbsp;</td>
            <td width="560" class="ro" align="center" nowrap>
                <div class="cell"><?php echo $th0 . $th1 . $th4 . $th2 . $th3 . $th6 . $th5 . $th7; ?></div>
            </td>
            <td width="13" class="ror">&nbsp;</td>
        </tr>
