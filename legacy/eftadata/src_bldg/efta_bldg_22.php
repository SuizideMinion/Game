...
if($_REQUEST["do"]==1 AND $level>=$maxplayerlevel){
	//setze die werte zur�ck
	mysql_query("UPDATE de_cyborg_data SET str=10, dex=10, konst=10, inbldg=0, x=0, y=0, map=0, oldx=0, oldy=0, hp=100, hpmax=100, mp=0, mpmax=0, bewpunkte='getDefaultVariable('sv_max_efta_bew_punkte')', exp=0, explastday=0, incarnation=incarnation+1, level=1, backpacksize=10, buff1=0, cooldown1=0 WHERE user_id='$efta_user_id'",$eftadb);
