...
if(getDefaultVariable('sv_efta_in_de')==1)
{
...
$gpfad=getDefaultVariable('sv_image_server_list')[0].'s/';
    ...
    if($_REQUEST["newspielername"])
	{
  	  ...
  	  if(strlen($_REQUEST["newspielername"])>2 AND strlen($_REQUEST["newspielername"])<=20)
      {
    	//testen ob er nur aus buchstaben besteht
  		if(!preg_match ("#^[������a-z-]+$#i", $_REQUEST["newspielername"]))$fehlermsg.='Der Spielername ist ung�ltig.<br>';
  		else
  		{
...
else  //neuen char anlegen
{
  ...
  //wenn gr��er null, die session berichtigen
  if($euid>0)
  {
  ...
  else
  {
    ...
    $mp=0;
  	...
  	mysql_query("INSERT INTO de_cyborg_data (ext_user_id, spielername, sn_ext1, str, dex, konst, hp, hpmax, mp, mpmax, bewpunkte, exp, level, map, x, y, oldx, oldy, showinfo, fixenm) VALUES ('$ums_user_id', '$spielername', 'getDefaultVariable('sv_server_tag')','$str', '$dex', '$konst', '$hp', '$hpmax', '$mp', '$mpmax', '$bewpunkte', '$exp', '$level', '$map', '$x', '$y','$x', '$y','s0','s0')",$eftadb);
  	...
  	//nachdem die gegenst�nde hinterlegt wurden diese auch anlegen
  	...
  	//den efta-account mit dem de-account verkn�pfen
...
if(($lastap+$zeitintervall)<time())
{
  ...
  $mpunkte=getDefaultVariable('sv_max_efta_bew_punkte')-$bewpunkte;
...
//nachricht nach dem lesen l�schen
...
//exp f�r den n�chsten level
$nextlevelexp=(($level+1)*500)*($level/2);

////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
//obere leiste mit allen infos und aktionsm�glichkeiten
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
function show_infobar()
{
	global getDefaultVariable('sv_efta_in_de'), $gpfad, $ums_gpfad, $nextlevelexp, $level, $bewpunkte, getDefaultVariable('sv_max_efta_bew_punkte'), $hp, $hpmax, $mp, $mpmax, $exp, $restyp05, $player_buff1;
	...
	$bcolor='#00FF00';
	if($bewpunkte<=getDefaultVariable('sv_max_efta_bew_punkte')*0.75)$bcolor='yellow';
	if($bewpunkte<=getDefaultVariable('sv_max_efta_bew_punkte')*0.50)$bcolor='orange';
	if($bewpunkte<=getDefaultVariable('sv_max_efta_bew_punkte')*0.25)$bcolor='red';
	...
	if(getDefaultVariable('sv_efta_in_de')==1)echo '&nbsp;Tronic: '.number_format(floor($restyp05), "0",",",".");
	//echo '&nbsp;X: '.$x.' Y: '.$y;
	echo '</span>';
	...
	if(getDefaultVariable('sv_efta_in_de')==1 AND $_SESSION['ums_mobi']==1)
	{
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
//bildgr��e der mapfiles vergr��ern
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
/*
if($_REQUEST["mvs"]==1)
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
if($_REQUEST['action']=='optionspage' AND getDefaultVariable('sv_efta_in_de')==0)
{
...
{
  //schauen ob es dort ne info f�r den spieler gibt
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
//baumen� und geb�ude minen/ernten
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
//stadt/heldent�rme/sonstwas betreten
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
if ($_REQUEST["enterbldg"]>0)
{
  ...
  if($num==1)
  {
    ...
    elseif($bldg==17)//reisender m�nch
    {
      mysql_query("UPDATE de_cyborg_data SET inbldg='$bldg' WHERE user_id='$efta_user_id';",$eftadb);
      $inbldg=$bldg;
    }
    elseif($bldg==21)//taschenverk�ufer bis stufe 20
    {
      mysql_query("UPDATE de_cyborg_data SET inbldg='$bldg' WHERE user_id='$efta_user_id';",$eftadb);
      $inbldg=$bldg;
    }
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
// stadt/heldenturm/geb�ude betreten, wenn man in einem ist
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
if($inbldg>0)
{
...
if($_REQUEST['w'])
{
  ...
  if($num==1 AND $w>0 AND $w<5)
  {
    ...
    if ($feldtyp==1 OR $feldtyp==15)//man kann draufgehen
    {
      ...
      //schauen ob man eine verg�nstigung durch eine stra�e hat
  ...
  if ($go==1)//wenn man sich bewegt hat, dann ist es m�glich mit etwas zu interagieren
  {
    ...
    //alle koordinaten parsen und schauen ob was pa�t
...
//auf stra�e �berpr�fen
for($j=0;$j<$mapy;$j++)
{
  for($i=0;$i<$mapx;$i++)
  {
    if($maparray[$j][$i][2]==19)//wenn geb�udetyp 19 = stra�e
    {
      //schauen ob das nachbarfeld auch ein stra�enfeld ist
...
else //geb�udeaktionen
{
  ...
  else//alle anderen geb�ude
  {
  	//geb�udename auslesen
...
//div der karte mit den maximal m�glichen ausma�en von x/y 10 mio
