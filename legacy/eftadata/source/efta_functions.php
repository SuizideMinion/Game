...
function cyborg_die($user_id, $typ, $msg)
{
  ...
  elseif($typ==1)//n�chstgelene stadt
  {
...
function change_credits($uid, $amount, $reason)
{
  global $db, $eftadb, getDefaultVariable('sv_efta_in_de');
...
function get_player_flag($flag_id)
{
  ...
  //schauen ob es daf�r schon ein flag gibt
...
function make_moneystring($money)
{
  ...
  //schauen ob der wert gr��er 0 ist
