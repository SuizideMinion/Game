<?php
//das script f�rs rasten und f�r die ausr�stung usw.
echo '<br><br>';
switch($r){
  case 2: //regenerieren
    //ben�tige bewegungspunkte f�r das regenerieren berechnen
  ...
  case 3: //energietransfer
    if(getDefaultVariable('sv_efta_in_de')==1)
    {
      ...
      $tronic=$row["restyp05"];
      if($bewpunkte<=(getDefaultVariable('sv_max_efta_bew_punkte')-500) && $tronic>0)
      {
  ...
  case 4: //psienergie regenerieren
    ...
    case 5: //heilige kraft
      ...
      if($bewpunkte<=(getDefaultVariable('sv_max_efta_bew_punkte')-1000) && $hascredits>0)
      {
		//credits abziehen
