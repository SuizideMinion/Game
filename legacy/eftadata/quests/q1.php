...
//anzahl der m�glichen quests berechnen: maxwt-952 / 48
//$result  = mysql_query("SELECT MAX(tick) AS tick FROM de_user_data",$db);
if(getDefaultVariable('sv_server_tag')=='123'){
...
//koordinaten f�r quests u.�. definieren
//map, x, y
//lm1
...
//erst sp�ter im spiel integriergen, abh�ngig von der verstrichenen rundenlaufzeit
if($maxtick>0)
{
if(getDefaultVariable('sv_winscore')/$maxtick<2)$efta_koord[]= array (  0,   -56,  -74);
//lm2
if(getDefaultVariable('sv_winscore')/$maxtick<1.6)$efta_koord[]= array (  0,  382, 690);
//lm3
if(getDefaultVariable('sv_winscore')/$maxtick<1.5)$efta_koord[]= array (  0,  660, -111);
//lm4
if(getDefaultVariable('sv_winscore')/$maxtick<1.2)$efta_koord[]= array (  0,  351, -680);
}
...
{
  //�berpr�fen ob man noch weitere quets machen darf
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
if(getDefaultVariable('sv_efta_in_de')==1 AND $showmenu==1)
{
  //�berpr�fen ob man bereits einen passenden db-eintrag hat
  $db_daten=mysql_query("SELECT * FROM de_cyborg_quest WHERE user_id='$efta_user_id' AND typ=1",$eftadb);
  ...
  //bereich f�r den sprung zur n�chsten quest
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
if(getDefaultVariable('sv_efta_in_de')==1 AND !isset($_REQUEST["tqcancel"]) AND isset($questid) AND !isset($showmenu))
{
  //questname
  ...
  //flag 10: transmitterw�chter get�tet

  //�berpr�fen ob man das eftaprojekt hat
  //if ($techs[25]!=0){//efta-projekt

  //�berpr�fen ob man noch weitere quets machen darf
  if($flag2<$maxtquests){//es geht noch weiter
  	//�berpr�fen ob man gerade bei der 1. station, oder schon weiter ist
      ...
      if($flag10>0)
      {
        ...
        $dokampf=1;
        //schauen ob er die ben�tigten x tronic hat
  ...
  else //keine weitere quest m�glich
  {
