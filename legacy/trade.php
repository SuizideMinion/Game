...
include_once('functions.php');
    ...
    include 'inc/lang/'.getDefaultVariable('sv_server_lang').'_trade.trade.lang.php';
	//21.01.2004, f�r den schwarzmarkt m�ssen die credits und der pa-laufzeit ausgelesen werden, Isso
	...
	//21.01.2004, f�r den schwarzmarkt m�ssen die credits und die ticks ausgelesen werden, Isso
	//06.05.2004, f�r den schwarzmarkt m�ssen noch mehr felder ausgelesen werden, Isso
    $credits    = $row["credits"];
    $tick       = $row["tick"];
