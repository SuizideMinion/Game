<?PHP
include 'inc/lang/'.getDefaultVariable('sv_server_lang').'_dezmyinc.lang.php';
?>
	...
	<?php
		...
		if ($ZID == 0) {
			...
			if (($AAnz != 0) || ($KAnz != 0)) {
				...
				//echo '  <td align="right">&nbsp;</td></tr></table><br>';
				//echo '<div style="width: 600px; text-align: right;"><span style="color: #FF2828;">Es ist keine Statistik verf�gbar!</span></div>';
			}
		}
	?>
